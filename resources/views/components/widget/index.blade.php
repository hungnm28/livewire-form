...
<div {{$attributes->merge(['class'=>'relative flex-auto overflow-hidden rounded-3xl border border-slate-200/70 bg-white/85 p-4 shadow-2xl shadow-slate-950/10 ring-1 ring-slate-900/10 backdrop-blur-2xl dark:border-white/10 dark:bg-slate-950/70 dark:shadow-black/25 dark:ring-white/10 inline-flex items-center'])}}>
    <div class="pointer-events-none absolute -right-8 -top-8 size-24 rounded-full bg-primary-300/25 blur-2xl dark:bg-primary-400/15"></div>
    <div class="relative flex aspect-square flex-none items-center justify-center rounded-2xl border border-primary-200/70 bg-primary-500/85 p-4 text-white shadow-lg shadow-primary-700/20 backdrop-blur-xl dark:border-primary-200/30 dark:bg-primary-400/80">
