...
<body x-data class="relative z-0 min-h-screen overflow-hidden font-sans text-slate-900 antialiased dark:text-slate-100" data-theme="{{$theme_color}}" {{$aside_mode}}>
...
<div class="relative z-0 flex min-h-screen w-full bg-white/10">
    {{$aside}}
    <div class="relative min-h-screen w-full flex-auto overflow-auto border border-slate-200/70 bg-white/80 shadow-2xl shadow-slate-950/10 backdrop-blur-2xl dark:border-white/10 dark:bg-slate-950/70 dark:shadow-black/20">
        {{$slot}}
    </div>
    <x-lf::aside.overlay />
</div>
