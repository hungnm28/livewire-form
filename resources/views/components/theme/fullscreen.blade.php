...
>
    <svg id="fullscreenIcon" class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5"
        ...
        <path id="enterIcon" stroke-linecap="round" stroke-linejoin="round"
              d="M8.25 3h-3a.75.75 0 00-.75.75v3m12-3h3a.75.75 0 01.75.75v3m0 8.5v3a.75.75 0 01-.75.75h-3m-12-3v3a.75.75 0 00.75.75h3" />
    </svg>
